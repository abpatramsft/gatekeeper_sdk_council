...
# Copy .env file (contains Azure credentials for agent analysis)
# NOTE: For production, prefer passing env vars via --env-file or platform config
COPY .env* ./

# Copy the standalone fetch script (optional utility)
COPY copilot_session_fetch.py ./
